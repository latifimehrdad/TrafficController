...
public class ML_SphericalUtil {
    private ML_SphericalUtil() {
    }
    ...
    public static double computeHeading(LatLng from, LatLng to) {
        ...
        return ML_MathUtil.wrap(Math.toDegrees(heading), -180.0D, 180.0D);
    }
    ...
    private static double distanceRadians(double lat1, double lng1, double lat2, double lng2) {
        return ML_MathUtil.arcHav(ML_MathUtil.havDistance(lat1, lat2, lng1 - lng2));
    }
